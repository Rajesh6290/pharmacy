...
import { useCart } from "@/features/store/store/cartContext";
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-md">
      ...
      <div className="border-accent-100 border-b bg-white">
        <div className="mx-auto flex h-16 max-w-360 items-center gap-3 px-4 sm:px-6 lg:px-8">
          {/* Logo */}
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            >
              ...
              {totalItems > 0 && (
                <span className="bg-primary-500 absolute -top-0.5 -right-0.5 flex h-4.5 w-4.5 items-center justify-center rounded-full text-[10px] font-bold text-white">
                  ...
                  {userMenuOpen && (
                    ...
                    >
                      ...
                      >
                        ...
                        {totalItems > 0 && (
                          <span className="bg-primary-100 text-primary-700 ml-auto rounded-full px-1.5 py-0.5 text-[10px] font-bold">
                            {totalItems}
                          </span>
                        )}
                      </Link>
        ...
        {menuOpen && (
          ...
          >
            <div className="space-y-0.5 px-4 py-3">
              {[
                { href: "/store", label: "Browse All Medicines" },
                { href: "/cart", label: "My Cart" },
                { href: "/users", label: "My Orders" },
              ].map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
